...
Source
code\footnote{\url{https://github.com/KitwareMedical/CardiacUltrasoundPhaseEstimation}}
and data\footnote{\url{https://data.kitware.com/todo-add-collection-url}} used in the analysis are available online.
